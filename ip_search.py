...
def main():
    ...
    ## RIPE SEARCH
    ##################################################################################    
    ripedb_fname='/Users/llejariel/Fujaco/Devs/Python/inetdb'+'/'+'ripe.db.inetnum.gz'
    ...
    logging_config = { 
        ...
        'handlers': { 
            ...
            'fh': {'level': 'INFO','formatter': 'standard','class': 'logging.handlers.RotatingFileHandler',
                   'filename': 'ip_search.log','mode': 'a','encoding': 'utf-8',
...
## read_cli():
def read_cli():
    help_str='ip_search.py -c <company_name>'
    params={'company_name':''}
